...
public class ReportePorductos extends Conexion  {
    
     public void ReportePdfVentas(String root, String numeroacta) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException{
        try {
